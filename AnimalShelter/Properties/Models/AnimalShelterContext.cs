  ...
  public class AnimalShelterContext : DbContext
  {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
      ...
      builder.Entity<Animal>()
          .HasData(
              new Animal { AnimalId = 1, UserId = 4, DateCreated = DateTime.Now, AnimalName = "Yanaba", AnimalSpecies = "Polar Bear", Availability = true, AnimalBreed = "Unknown", Description = "Afraid of shoes" },
